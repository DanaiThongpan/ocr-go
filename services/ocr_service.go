...
import (
	...
	"ocr-go/models" // แก้ไขชื่อ module ให้ตรงกับโปรเจกต์ของคุณ

	"github.com/otiai10/gosseract/v2"
)

// ProcessPDF แปลง PDF เป็นรูปภาพ, ทำ OCR และดึงข้อมูลเกรด
...
// ExtractGrades สกัดข้อมูลวิชาและเกรด
